...
void Analyzer::branchesMuons(TTree* tree) {
...
void Analyzer::fillMuons(const edm::Event& e, math::XYZPoint& pv, reco::Vertex vtx) {
  ...
  if (!muonHandle.isValid()) {
    edm::LogWarning("Analyzer") << "no pat::Muons in event";
    return;
  }
