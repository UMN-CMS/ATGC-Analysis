...
Analyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   //std::cout<<"================================="<<std::endl;
	 ...
	 */
	 ...
	 //std::cout<<"isPromptDecayed : isLastCopyBeforeFSR  : fromHardProcessBeforeFSR : fromHardProcessDecayed : fromHardProcessFinalState "<<ip->isPromptDecayed()<<" "<<ip->isLastCopyBeforeFSR()<<" "<<ip->fromHardProcessBeforeFSR()<<" "<<ip->fromHardProcessDecayed()<<" "<<ip->fromHardProcessFinalState()<<std::endl;
