...
void Analyzer::branchesGlobalEvent(TTree* tree) {
...
void Analyzer::fillGlobalEvent(const edm::Event& e, const edm::EventSetup& es) {
  ...
  if (vtxHandle.isValid()) {
    ...
    edm::LogWarning("Analyzer") << "Primary vertices info not unavailable";
